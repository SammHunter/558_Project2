...
Then I build a contingency table between what day of the week an article was published and what quartile it ends up in. Finally I preform the Chi-Squared test.
```{r evan quartiles}
