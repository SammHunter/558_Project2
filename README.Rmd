...
#this causes an error for me, I just commented it out so I can knit the doc

detach(num_summary)

ggplot(data = world, aes(x = shares)) + 
  geom_histogram(fill = day)
...
# all of the significant variables from the full model
...
=======
>>>>>>> 9060071cc39fd334a70a73471d04c9bab4a4148e
...
=======
# 2618.21, pretty small comparitively so this is what I'm going to use for the cross-validation training
>>>>>>> 9060071cc39fd334a70a73471d04c9bab4a4148e
...
rf_SigPred <- predict(model, newdata = train_set)
...
```{r}
topic<-as.vector(unique(data$topic))


# Turn all of the above into a function, then use lapply on the render. 
```
