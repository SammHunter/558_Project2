...
This is not ready to go, but taking a break and pushing
...
test <- train(shares ~ LDA_02 + LDA_03 + num_imgs*n_tokens_content  + I(average_token_length^2) + kw_avg_avg + rate_negative_words*rate_positive_words
...
tst_pred <- predict(test,newdata = test_set)



test2 <- train(shares ~ LDA_02 + LDA_03 + num_imgs*n_tokens_content  + I(average_token_length^2) + kw_avg_avg + rate_negative_words*rate_positive_words
                  + kw_max_avg + day + title_subjectivity  ,
              data = train_set,
              preProcess = c("center","scale"),
              method = "lm")
