...
# Names of models
model_names <- c("Full Linear Model", "Selected Linear Model 2 ","Full Boosted Tree Model", 
                 "Selected Boosted Tree Model", "Random Forest Model","Selected Linear Model 1") # these can be added to, just getting the first try at this down

# RMSE values
model_rmses <- c(lm_full_rmse,lm2_rmse,boost_tree_full_rmse,
                 boost_tree_rmse,rf_MSE,lm_9_rmse)  # these can be added to
